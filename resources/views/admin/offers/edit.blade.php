    ...
    <section class="content">
        <div class="main_div" style="max-width:1564px">
            <div class="sale_list">
                ...
                <h2>Offer Form</h2>
                <!-- form begin here -->
                <form action="{{ route('admin.offers.update', ['id' => $offer->id]) }}" method="POST" id="myform">
                    @csrf
                    @method('PUT')
                    <div class="user-details">
                        <div class="input-box">
                            <span class="details">Offer Name:</span>
                            <input type="text"  id="offer_name" name="offer_name" value="{{$offer->offer_name}}" required>
                            @error('offer_name')
                        ...
                        <div class="input-box">
                            ...
                            <input type="text"  id="discount_percentage" name="discount_percentage" value="{{$offer->discount_percentage}}" required>
